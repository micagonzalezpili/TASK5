...
const app = createApp({
        ...
        fetch(url)
            ...
            .then(data => {
                ...
                console.log(this.pastEvents);
                   this.categories = Array.from(new Set(this.pastEvents.map(e => e.category)))
    ...
    computed: {
        filtrosCombinados() {
            let aux = this.pastEvents.filter(event => event.name.toLowerCase().includes(this.nombreIngresado.toLowerCase()))
